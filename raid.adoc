...
[disc]
* The disk is too recent (you probably inserted the _new_ shelf disk).
...
NOTE: If you are unsure, you can always seek expert advice first.

.. Shut the system down (as _root_: `*shutdown -h now*`).

.. Remove the _secondary_ disk and put it where it belongs.
...
.. If this disk is also rejected, seek expert advice. Otherwise,
