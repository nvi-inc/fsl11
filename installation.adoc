...
_10.2.0-alpha3_. That, or a later tagged alpha version or beta
...
been made to make it safe, but it installs a non-standard package. It
is best to avoid installing it if you don't require it.
