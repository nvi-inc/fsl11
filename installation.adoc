...
NOTE: If _Bullseye_ is no longer the current release, you will also
need to modify _sources.list_ as described in the
<<End of security updates>> in <<Managing Security Updates>> appendix.
