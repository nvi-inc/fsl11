...
* 1.1.2 -- Include link to Debian archive
...
can be found at: https://cdimage.debian.org/cdimage/release/ (or when no
longer the current release at:
https://cdimage.debian.org/cdimage/archive/). Alternatively,
