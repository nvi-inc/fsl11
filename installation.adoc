...
update (see <<Kernel updates>> below) or related to an insecure
package that was removed (see <<Removing insecure packages>> below).
Normally, any reinstalled insecure packages should be removed again
after upgrading.
