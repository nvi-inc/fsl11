...
Addition setup for _ufw_ is covered below in the <<More firewall
rules>> subsection.
...
this.  All the subsections below assume you are in program and have
