...
to the accounts. There are two options:

. If you did _not_ use the remediate2_ script, run _visudo_ then add
at end:
...
. If you _did_ use the remediate2_ script, run _visudo_ then add at
end:
